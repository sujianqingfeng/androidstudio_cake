...
public class MyActivityManager {
    ...
    public Activity currentActivity() {
        ...
        LogUtil.e("get current activity:" + activity.getClass().getSimpleName());
        return activity;
    }
    ...
    public void addActivity(Activity activity) {
        ...
        LogUtil.e("push stack activity:" + activity.getClass().getSimpleName());
    ...
    public void finishActivity(Activity activity) {
        if (activity != null) {
            activity.finish();
            LogUtil.e("remove current activity:" + activity.getClass().getSimpleName());
