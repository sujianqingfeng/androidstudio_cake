 ...
 * @author 12111
 */
public class SpongeCakeFragment extends BaseFragment {
    ...
    protected View createSuccessView() {
        View view = View.inflate(getActivity(), R.layout.spongecake_fragment, null);
        return view;
    }

    @Override
    protected LoadingPage.LoadResult load() {
        LogUtil.e("海绵蛋糕 ----datalist的个数为" + dataLists.size());
        if (dataLists.size() > 0) {
    ...
    private void getDateFromService() {
        ...
        OkHttpUtils
                .get()
                .addParams("commodity_type_id", String.valueOf(5))
                ...
                .execute(new CommodityCallback() {
                    ...
                    public void onResponse(CommodityCallBackEntity response, int id) {
                        if (response.getList().size() > 0) {
                            LogUtil.e("海绵蛋糕的json解析数据" + response.getList().toString());
